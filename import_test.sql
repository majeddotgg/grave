-- Islamic Grave Assignment System Test Database Schema
-- Compatible with MySQL 5.7+

-- Drop existing database and recreate
DROP DATABASE IF EXISTS islamic_grave_system_test;
CREATE DATABASE islamic_grave_system_test 
CHARACTER SET utf8mb4 
COLLATE utf8mb4_unicode_ci;

USE islamic_grave_system_test;
